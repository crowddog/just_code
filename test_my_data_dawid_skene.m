...
% function[z, predZ]=test_my_data_dawid_skene(tag_template)
startup()
difficulty = 'off';
tag_template = 'dog1';
settings = struct();
...
v = (1:K)';
init_id = 1;
[predZ,predA] = dawid_skene(settings, x, nQueryUrls, nLabelers, nLabels, K, v, init_id, difficulty, expt);
...
% accuacy = compute_accuracy(z, predA);
% [mse, mae, corr_coef, zero_one_acc, err] = compute_metrics_simple(z, predZ);
% fprintf('mse = %.3f, mae = %.3f, corr = %.3f, zero_one_acc = %.3f\n', mse, mae, corr_coef, zero_one_acc);
% end